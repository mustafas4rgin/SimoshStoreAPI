...
public class BlogEntity : EntityBase, IHasEnabled
{
    ...
    public ICollection<RelBlogTagEntity> BlogTags { get; set; } = new List<RelBlogTagEntity>();
    public ICollection<RelBlogCategoryEntity> BlogCategories { get; set; } = new List<RelBlogCategoryEntity>();
